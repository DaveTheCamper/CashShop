...
public class TransactionInfo {
	...
	public TransactionInfo(String link, String transaction_token) {
		this(null, 0, System.currentTimeMillis(), link, transaction_token);
	}
	
	public TransactionInfo(CashShopGateway gateway, int cash, long creation_date, String link, String transaction_token) {
		this.link = link;
		this.transaction_token = transaction_token;
		this.api_caller = gateway != null ? gateway.getIdentifier() : "null";
		this.status = TransactionResponse.WAITING_FOR_PAYMENT;
		this.cash = cash;
		this.creation_date = creation_date;
	}
	
	private String link, transaction_token, api_caller;
